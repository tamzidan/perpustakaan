          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a
                    href="{{ route ('kategori') }}" class="menu-link"
                    {{-- target="_blank" --}}
                    class="menu-link">
                    <div data-i18n="CRM">Data Kategori</div>
                ...
                <li class="menu-item">
                  <a
                    href="{{ route ('peminjaman.index') }}" class="menu-link"
                    {{-- target="_blank" --}}
                    class="menu-link">
                    <div data-i18n="eCommerce">Data Peminjaman</div>
                    <div class="badge bg-label-primary fs-tiny rounded-pill ms-auto">Pro</div>
                  </a>
                </li>
                {{-- <li class="menu-item">
